"""
Skill: code_pipeline
Description: Orchestrate code quality pipeline - review, coverage, test generation
Version: 1.0.0
Tier: tested
...
SKILL_META = {
    ...
    "author": "duro",
    "phase": "4.4",
    "triggers": ["run pipeline", "code pipeline", "project health", "quality check"],
}
...
def run(args: Dict[str, Any], tools: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    all_stages = ["code_review", "test_coverage", "test_generate"]
...
def main():
    ...
    parser.add_argument(
        ...
        nargs="+",
        default=["all"],
        choices=["all", "code_review", "test_coverage", "test_generate"],
        help="Stages to run"
    )
    parser.add_argument(
        "--format",
