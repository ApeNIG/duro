...
RETRIEVAL_TRIGGERS = {
    ...
    "architecture": ["architecture", "pattern", "approach"],

    # Design & creative work
    "design": ["design", "ui", "visual", "pencil", "gym", "practice", "reps",
               "drills", "storyboard", "mockup", "layout", "typography"],
...
def category_to_search_params(categories: list[str]) -> dict:
    ...
    category_mappings = {
        ...
        "design": {
            "tags": ["design", "design-gym", "reps", "practice", "pencil", "ui", "visual"],
